...
public class ClaimBehaviourData {
    ...
    public enum ClaimBehaviourMode {
        ...
        public boolean performTest(GriefPreventionTNG plugin, Location testLocation, Player testPlayer, boolean ShowMessages) {
            PlayerData pd;
    ...
    */
	...
	public ClaimBehaviourData(GriefPreventionTNG plugin, String pName, FileConfiguration source, FileConfiguration outConfig, String nodePath, ClaimBehaviourData defaults) {
		this.plugin = plugin;
        behaviourName = pName;
	...
	public ClaimBehaviourData(GriefPreventionTNG plugin, String pName, PlacementRules pWilderness, PlacementRules pClaims, ClaimBehaviourMode cb) {
        this.plugin = plugin;
	...
	public static ClaimBehaviourData getOutsideClaims(GriefPreventionTNG plugin, String pName) {
    ...
    public static ClaimBehaviourData getBelowSeaLevel(GriefPreventionTNG plugin, String pName) {
    ...
    public static ClaimBehaviourData getNone(GriefPreventionTNG plugin, String pName) {
        return new ClaimBehaviourData(plugin, pName, PlacementRules.NEITHER, PlacementRules.NEITHER, ClaimBehaviourMode.REQUIRE_NONE);
    }

    public static ClaimBehaviourData getAll(GriefPreventionTNG plugin, String pName) {
