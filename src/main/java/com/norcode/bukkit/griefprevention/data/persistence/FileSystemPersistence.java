package com.norcode.bukkit.griefprevention.data.persistence;
...
import com.norcode.bukkit.griefprevention.exceptions.DatastoreException;
...
public class FileSystemPersistence implements IPersistence {
    ...
    public FileSystemPersistence(GriefPreventionTNG plugin) {
        this.plugin = plugin;
    }
