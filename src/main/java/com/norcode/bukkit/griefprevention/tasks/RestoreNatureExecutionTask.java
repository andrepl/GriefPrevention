...
class RestoreNatureExecutionTask implements Runnable {
    ...
    public RestoreNatureExecutionTask(GriefPreventionTNG plugin, BlockSnapshot[][][] snapshots, int miny, Location lesserCorner, Location greaterCorner, Player player) {
        this.plugin = plugin;
