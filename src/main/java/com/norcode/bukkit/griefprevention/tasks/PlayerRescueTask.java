...
public class PlayerRescueTask implements Runnable {
    ...
    public PlayerRescueTask(GriefPreventionTNG plugin, Player player, Location location) {
        this.plugin = plugin;
        this.player = player;
    ...
    public void run() {
        ...
        plugin.getLogger().info("Rescued trapped player " + player.getName() + " from " + GriefPreventionTNG.getfriendlyLocationString(this.location) + " to " + GriefPreventionTNG.getfriendlyLocationString(destination) + ".");
