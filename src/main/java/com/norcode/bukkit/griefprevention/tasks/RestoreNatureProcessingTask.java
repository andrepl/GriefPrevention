...
import com.norcode.bukkit.griefprevention.BlockSnapshot;
...
public class RestoreNatureProcessingTask implements Runnable {
    ...
    public RestoreNatureProcessingTask(GriefPreventionTNG plugin, BlockSnapshot[][][] snapshots, int miny, Environment environment, Biome biome, Location lesserBoundaryCorner, Location greaterBoundaryCorner, int seaLevel, boolean aggressiveMode, boolean creativeMode, Player player) {
        this.plugin = plugin;
