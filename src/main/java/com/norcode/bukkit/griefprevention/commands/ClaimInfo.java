...
public class ClaimInfo extends BaseCommand {
    ...
    public ClaimInfo(GriefPreventionTNG plugin) {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, LinkedList<String> args) {
        ...
        if (claim == null) {
            ...
            String lowerBoundary = GriefPreventionTNG.getfriendlyLocationString(claim.getMin());
            String upperBoundary = GriefPreventionTNG.getfriendlyLocationString(claim.getMax());
